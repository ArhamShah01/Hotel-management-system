...
def inputdata():
    ...
    print("1. Duplex --- >Rs 15000 PN-")
    print("2. Cabana --- >Rs 12500 PN-")
    print("3. Lanai --- >Rs 20000 PN-")
    print("4. Suit --- >Rs 25000 PN-")
    print("5. Mini --- >RS 7500 PN-")
...
7.Next''')
    ...
    print("Subtotal bill is Rs", SubTotal_bill)
    print("Tax @5% is Rs", 0.05 * SubTotal_bill)
    ...
    data1 = (Ccode,Cname,Cadd,Cindate,Coutdate,Room_no,Cid_type,Cid_no,Ccontact_no,CNationality)
