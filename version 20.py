...
def inputdata():
    ...
    writecsv( Ccode, Cname, Cid_type, Cid_no, Cadd, CNationality, Cindate, Coutdate, Room_no, Ccontact_no )
...
def writecsv(Ccode, Cname, Cid_type, Cid_no, Cadd, CNationality, Cindate, Coutdate, Room_no, Ccontact_no):

    data = [Ccode, Cname, Cid_type, Cid_no, Cadd, CNationality, Cindate, Coutdate, Room_no, Ccontact_no]

    with open('customer_data_v2.csv', 'a', newline='', encoding='utf-8') as file:
