...
# CSV file path
csv_path = r"C:/Users/Shiwang Rao/OneDrive/Desktop/MYSQL/customer_data_v2.csv"
...
mycursor.execute("""create table if not exists Customer(Ccode varchar(1000),Cname nvarchar(50),Cid_type nvarchar(20),Cid_no varchar(25) primary key , Cadd varchar(50),CNationality varchar(20),Cindate varchar(15),Coutdate varchar(15),Room_no varchar(5000), Ccontact_no varchar(15))""")
...
def inputdata():
    ...
    num = int(last_id[1:]) + 1
    Ccode = f"C{num:04d}"  
    print("Enter details for Customer: ", Ccode)
    ...
    print("1. Duplex --- >Rs 15000 PN- --- > ", empty_rooms[0])
    print("2. Cabana --- >Rs 12500 PN- --- > ", empty_rooms[1])
    print("3. Lanai --- >Rs 20000 PN- --- > ", empty_rooms[2])
    print("4. Suit --- >Rs 25000 PN- --- > ", empty_rooms[3])
    print("5. Mini --- >RS 7500 PN- --- > ", empty_rooms[4])
    ...
    Smoking = input("Would you like Smoking? (y/n): ")
...
5.Next''')
    ...
    while (1):
        ...
        if (c == 1):
            d = int(input("Enter the number of meals:"))
            r = r + 599 * d
        elif (c == 2):
            d = int(input("Enter the number of meals:"))
            r = r + 799 * d
...
7.Next''')
    ...
    loyalty = input("Are you a loyalty customer? (y/n): ")
    if loyalty.lower() == 'y' or "Y":
        discount = 0.10 * s
        s -= discount
        ...
        loyalty_input = input("Enter 'y' to enroll or 'n' to skip: ")
        if loyalty_input.lower() == 'y' or 'Y':
    ...
    Game_bill = p
    Food_bill = r
    GrandTotal_bill = SubTotal_bill + 0.05 * SubTotal_bill
    Tax=0.05*SubTotal_bill
    print(f"Subtotal bill is ₹ {SubTotal_bill:.2f}")
    print(f"Tax @5% is Rs {Tax:.2f}")
    print("You have to pay Rs {GrandTotal_bill:.2f}")
    print("__________________________________________________")
    rec = "insert into hoteldata values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
    cotm = "insert into customer values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
    data1 = (Ccode,Cname,Cid_type,Cid_no,Cadd,CNationality,Cindate,Coutdate,Room_no,Ccontact_no)
